 ...
 */
 ...
 set(ConfPaths.BLOCKBREAK_FASTBREAK_ACTIONS, "cancel vl>5 cancel log:fastbreak:4:2:i vl>50 cancel log:fastbreak:0:2:if", 154);
 // Frequency
 ...
 set(ConfPaths.BLOCKBREAK_FREQUENCY_ACTIONS, "cancel vl>5 log:bbfrequency:3:5:i cancel vl>40 log:bbfrequency:0:5:if cancel", 154);
 // NoSwing
 ...
 set(ConfPaths.BLOCKBREAK_WRONGBLOCK_ACTIONS, "cancel vl>10 log:bwrong:2:5:i cancel vl>30 cancel log:bwrong:0:5:if", 154);
 ...
 set(ConfPaths.BLOCKINTERACT_DIRECTION_ACTIONS, "cancel vl>15 cancel log:bdirection:4:8:i vl>200 cancel log:bdirection:1:5:if", 154);
 // Reach
 ...
 set(ConfPaths.BLOCKINTERACT_SPEED_ACTIONS, "cancel vl>10 cancel log:bspeed:5:4:i cancel vl>500 cancel log:bspeed:0:5:icf", 154);
 // Visible
 ...
 set(ConfPaths.BLOCKPLACE_AGAINST_ACTIONS, "cancel log:against:1:5:i vl>10 cancel log:against:0:2:if", 154);
 // AutoSign
 ...
 set(ConfPaths.BLOCKPLACE_FASTPLACE_ACTIONS, "cancel vl>5 cancel log:fastplace:8:3:i vl>20 cancel log:fastplace:2:4:i vl>80 cancel log:fastplace:0:10:if", 154);
 // Reach
 ...
 set(ConfPaths.BLOCKPLACE_SCAFFOLD_ACTIONS, "cancel vl>10 cancel log:scaffold:3:7:if vl>70 cancel log:scaffold:0:5:if cmd:clearscaffold:0:1", 154);
 // Speed
 ...
 set(ConfPaths.CHAT_CAPTCHA_ACTIONS, "cancel vl>4 log:captcha:2:5:cf cancel", 154);
 // Commands
 ...
 set(ConfPaths.CHAT_COMMANDS_ACTIONS, "log:commands:0:5:cf cancel vl>20 log:commands:0:5:cf cancel cmdc:tempkick1", 154);
 ...
 set(ConfPaths.CHAT_TEXT_FREQ_NORM_ACTIONS, "cancel cmdc:tellchatnormal vl>7 log:chatnormal:0:5:cif cancel cmdc:tellchatnormal vl>20 log:chatnormal:0:5:cif cancel vl>40 log:chatnormal:0:5:cif cancel", 154);
 // ShortTerm 
 ...
 set(ConfPaths.CHAT_TEXT_FREQ_SHORTTERM_ACTIONS, "log:chatfast:2:3:icf cancel vl>20 cancel log:chatfast:0:5:cif vl>40 cancel log:chatfast:0:5:cif", 154);
 // Message
 ...
 set(ConfPaths.COMBINED_IMPROBABLE_ACTIONS, "cancel vl>50 log:improbable:8:9:if cancel vl>1500 cancel log:improbable:0:10:if", 154);
 // Invulnerable
 ...
 set(ConfPaths.FIGHT_CRITICAL_ACTIONS, "cancel vl>5 cancel log:critical:6:10:i vl>60 cancel log:critical:0:5:icf cmd:clearcritical:0:5", 1153);
 // Direction
 ...
 set(ConfPaths.FIGHT_DIRECTION_ACTIONS, "vl>2 log:fdirectionlowvl:5:6:i vl>10 cancel log:fdirection:2:4:if vl>50 cancel log:fdirection:0:7:icf", 154);
 // FastHeal, legacy
 ...
 set(ConfPaths.FIGHT_FASTHEAL_ACTIONS, "cancel vl>10 cancel log:fastheal:2:6:i vl>30 cancel log:fastheal:1:1:i vl>90 cancel log:fastheal:0:10:if", 154);
 // GodMode
 ...
 set(ConfPaths.FIGHT_GODMODE_ACTIONS, "cancel vl>10 cancel log:godmode:0:5:icf", 154);
 // NoSwing
 ...
 set(ConfPaths.FIGHT_REACH_ACTIONS, "cancel vl>1 cancel log:freach:8:9:i vl>5 cancel log:freach:2:6:i vl>12 cancel log:freachhighvl:1:5:if vl>35 cancel log:freachhighvl:0:5:if", 154);
 // SelfHit, legacy
 set(ConfPaths.FIGHT_SELFHIT_CHECK, "default", 154);
 set(ConfPaths.FIGHT_SELFHIT_ACTIONS, "cancel log:fselfhit:0:5:icf", 154);
 // Visible
 ...
 set(ConfPaths.INVENTORY_FASTCLICK_ACTIONS, "cancel vl>150 cancel log:fastclick:7:5:i vl>400 cancel log:fastclick:1:5:if vl>3000 cancel log:fastclick:1:2:if", 154);
 // InstantBow
 ...
 set(ConfPaths.INVENTORY_INSTANTBOW_ACTIONS, "cancel vl>15 cancel log:instantbow:4:5:i vl>200 cancel log:instantbow:0:10:if", 154);
 // FastConsume
 ...
 set(ConfPaths.INVENTORY_FASTCONSUME_ACTIONS, "cancel vl>2 log:fastconsume:2:5:if cancel vl>35 cancel log:fastconsume:0:5:if", 154);
 // Gutenberg
 set(ConfPaths.INVENTORY_GUTENBERG_CHECK, "default", 154);
 set(ConfPaths.INVENTORY_GUTENBERG_PAGELIMIT, 50, 154);
 set(ConfPaths.INVENTORY_GUTENBERG_ACTIONS, "cancel log:gutenberg:0:10:if", 154);
 // Open
 ...
 * */
 ...
 + "vl>2000 cancel log:creativefly:0:5:icf"
 , 154);
 // MorePackets
 ...
 set(ConfPaths.MOVING_TEMPKICKILLEGAL, false, 154);
 ...
 set(ConfPaths.MOVING_VEHICLE_MOREPACKETS_ACTIONS, "cancel vl>2 log:morepackets:2:5:if cancel vl>100 cancel log:morepackets:1:2:if", 154);
 ...
 set(ConfPaths.NET_ATTACKFREQUENCY_ACTIONS, "cancel vl>10 cancel log:attackfrequency:4:5:i vl>200 cancel log:attackfrequency:0:4:if", 154);
 // FlyingFrequency
 ...
 set(ConfPaths.NET_FLYINGFREQUENCY_ACTIONS, "cancel vl>20 cancel log:flyingfrequency:3:2:i vl>500 cancel log:flyingfrequency:0:5:if vl>1000 cancel log:flyingfrequency:0:2:icf", 154); 
 // KeepAliveFrequency
 ...
 set(ConfPaths.NET_PACKETFREQUENCY_ACTIONS, "cancel vl>2 cancel", 154);
 // SoundDistance
 ...
 set(ConfPaths.NET_WRONGTURN_ACTIONS, "cancel log:wrongturn:0:15:icf", 154);
