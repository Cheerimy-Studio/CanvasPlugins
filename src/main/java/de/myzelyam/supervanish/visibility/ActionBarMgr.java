...
public class ActionBarMgr {
    ...
    private void startTask() {
        FoliaScheduler.runTimerGlobal(plugin, () -> {
            for (Player p : actionBars) {
                try {
                    ...
                    // Can't easily cancel from inside the lambda on Bukkit; task will stop
                    // naturally on plugin disable. On Folia the lambda returns normally.
                    break;
                }
            }
        }, 0, 2 * 20);
